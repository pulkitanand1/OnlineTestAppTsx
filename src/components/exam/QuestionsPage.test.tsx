...
describe("Questions Page should have", () => {
    ...
    it('test next question button', () => {
        ...
        act(() => {
            const nextQuestionButton = screen.getAllByRole("button").find(b => b.innerHTML === "Next Question");
    ...
    it('test previous question button', () => {
        ...
        act(() => {
            const previousQuestionButton = screen.getAllByRole("button").find(b => b.innerHTML === "Previous Question");
    ...
    it('test the Download Result button', () => {
        ...
        act(() => {
            const downloadResultButton = screen.getAllByRole("button").find(b => b.innerHTML === "Download Result");
